defmodule HackathonApp.Adapter.InterfazConsolaLogin do
  ...
  alias HackathonApp.Adapter.{
    ...
    InterfazConsolaMentoria     # mentor (si ya lo tienes)
  }
  ...
  defp registrar_y_login do
    ...
    # Reusa tu flujo de registro en InterfazConsolaEquipos / UsuarioServicio
    case apply(HackathonApp.Service.UsuarioServicio, :registrar, [nombre, correo, rol, pass]) do
  ...
  # ---------- Ruteo por rol ----------
  # organizador => menú general con todos los módulos
  # mentor => interfaz de mentoría
  # participante => interfaz de proyectos
  ...
  defp ruteo_por_rol(_otro),          do: IO.puts("Rol desconocido"); iniciar()
  ...
  defp to_str(nil), do: ""; defp to_str(s), do: s |> to_string() |> String.trim()
end
